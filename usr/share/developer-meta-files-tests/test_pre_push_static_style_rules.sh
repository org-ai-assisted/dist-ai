...
## stcat implements the end-of-options marker (it drops a leading '--'), so
## 'stcat -- FILE' correctly reads FILE and must NOT be flagged.
expect_rule "R-062" "value=\$(stcat ${dd} \"\${target_file}\")"  "absent"
