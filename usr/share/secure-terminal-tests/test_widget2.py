...
# rides the pyte ROW (drives the left gutter), never inline text -- so the copyable
# transcript holds ONLY the command output, and the un-terminated row is flagged.
