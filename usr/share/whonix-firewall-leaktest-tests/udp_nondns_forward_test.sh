...
rc=0
## Representative non-53 UDP: NTP (123) and QUIC/HTTP3 (443), over BOTH IPv6 and
## IPv4 (separate forward-drop paths). Tor carries no UDP but DNS, so each must hit
## the forward reject, not leave as direct UDP.
