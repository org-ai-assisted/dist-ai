...
## variables-lib.bsh was folded into the variables.d/ module dir as 05_lib.bsh
## (loaded first by help-steps/variables). Still a separate sourced-only file so
## this test can source the helpers directly.
variables_lib="${DM_VARIABLES_LIB:-${dm_checkout}/help-steps/variables.d/05_lib.bsh}"
